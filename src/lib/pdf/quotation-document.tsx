...
const styles = StyleSheet.create({
  ...
  // they sit right on top of the line — instead of floating near the top
  // with the line pushed far below (signLine used to be a separate sibling
  // with its OWN marginTop stacked on top of this box's full height, nearly
  // doubling the gap). Stamp sits slightly left/behind, signature overlaps
  // on top of it, matching SSO's real signed quotations.
