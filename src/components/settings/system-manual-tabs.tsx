    ...
    <div className="space-y-4">
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-3 overflow-x-auto">
              ...
              <FlowRow steps={["Project (auto)", "Vendor PO", "Invoice", "Payment", "Laporan Management"]} />
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div><span className="font-medium">WON</span> — saat Quotation ditandai Won, sistem <span className="font-medium">otomatis</span> membuat Project baru, folder dokumen project, numbering job, dan tugas default — tanpa input ulang data.</div>
              ...
              <div><span className="font-medium">Invoice</span> — tagihan ke customer. Melalui approval sebelum diterbitkan (Issued). Pembayaran baru bisa dicatat setelah invoice berstatus Issued/Partially Paid/Overdue.</div>
      ...
      {active === "dokumen" && (
        <div className="space-y-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-border">
                    ...
                    <tr><td className="py-1.5 pr-4">Opportunity</td><td className="py-1.5 font-mono text-xs">OPP</td></tr>
                    <tr><td className="py-1.5 pr-4">Costing Sheet</td><td className="py-1.5 font-mono text-xs">CST</td></tr>
                    <tr><td className="py-1.5 pr-4">Quotation</td><td className="py-1.5 font-mono text-xs">QUO/MKT</td></tr>
                    <tr><td className="py-1.5 pr-4">Purchase Order (dari customer)</td><td className="py-1.5 font-mono text-xs">PO</td></tr>
                    <tr><td className="py-1.5 pr-4">Vendor PO (SSO ke vendor)</td><td className="py-1.5 font-mono text-xs">PO/PRO</td></tr>
                    <tr><td className="py-1.5 pr-4">Kontrak</td><td className="py-1.5 font-mono text-xs">CTR</td></tr>
                    <tr><td className="py-1.5 pr-4">Project</td><td className="py-1.5 font-mono text-xs">PRJ</td></tr>
                    <tr><td className="py-1.5 pr-4">Invoice</td><td className="py-1.5 font-mono text-xs">INV/FIN</td></tr>
                    <tr><td className="py-1.5 pr-4">Payment</td><td className="py-1.5 font-mono text-xs">PAY</td></tr>
                    <tr><td className="py-1.5 pr-4">Expense</td><td className="py-1.5 font-mono text-xs">EXP</td></tr>
                    <tr><td className="py-1.5 pr-4">Dokumen umum lainnya</td><td className="py-1.5 font-mono text-xs">GEN — masuk folder &quot;General Documents&quot; project/opportunity terkait</td></tr>
                  </tbody>
                </table>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader><CardTitle>Folder Dokumen Otomatis</CardTitle></CardHeader>
      ...
      {active === "notifikasi" && (
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-3">
              <FlowRow steps={["Aksi: Submit / Approve / Reject", "Notifikasi in-app (selalu)", "Email (kalau dikonfigurasi)", "WhatsApp (kalau dikonfigurasi)"]} />
              <p className="text-sm text-muted-foreground pt-2">Notifikasi in-app selalu jalan (tidak butuh setting apa pun). Email &amp; WhatsApp baru terkirim setelah tiga variable di bawah ini diisi dan project di-redeploy.</p>
            </CardContent>
          </Card>
      ...
      {active === "developer" && (
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              Next.js 14 (App Router) + TypeScript · Prisma ORM + PostgreSQL (Neon) · Cloudflare R2 (file storage) · Vercel (hosting) · @react-pdf/renderer (PDF) · exceljs (Excel) · nodemailer (email) · Fonnte (WhatsApp).
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-1.5 text-sm">
              ...
              <div><code className="rounded bg-muted px-1">src/lib/workflows/*</code> — logika bisnis inti (create/submit/approve/reject tiap modul). Semua transaksi database dan aturan status hidup di sini, bukan di komponen UI.</div>
              ...
              <div><code className="rounded bg-muted px-1">prisma/*.ts</code> (di luar schema) — script maintenance satu-kali/berkala: sync nomor, cek customer kosong, reset data finansial percobaan, dsb. Semua aman dijalankan berkali-kali (idempotent) kecuali yang minta konfirmasi ketik &quot;DELETE&quot;.
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <div><span className="font-medium">Jangan panggil API eksternal (email/WA/HTTP lain) di dalam <span className="font-mono">prisma.$transaction()</span>.</span> Kumpulkan dulu apa yang perlu dikirim, kirim setelah transaksi commit. Ini pernah jadi penyebab error &quot;Transaction already closed&quot; di production.</div>
              ...
              <div><span className="font-medium">Nomor dokumen baru selalu lewat <span className="font-mono">generateNumber(tx, entityType)</span></span>, jangan pernah di-hardcode atau di-generate manual — supaya tidak bentrok dengan sistem sinkronisasi nomor.</div>
            </CardContent>
          </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            {[
              ...
              { label: "Konsep Kurva S (progress proyek vs termin penagihan)", done: false },
            ].map((item) => (
