...
export const metadata: Metadata = {
  title: { default: "SSO Connect", template: "%s Â· SSO Connect" },
  description:
    "Sales, Finance, Project & Document management for PT Sarana Sinergi Optima",
  // iOS Safari ignores the web manifest for "add to home screen" styling â€”
