...
- Workspace ID: `daa7a995-03a5-40ca-a909-6c9485d60ced`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/daa7a995-03a5-40ca-a909-6c9485d60ced.
...
2. `npx ngodingpakeai connect --workspace daa7a995-03a5-40ca-a909-6c9485d60ced --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/daa7a995-03a5-40ca-a909-6c9485d60ced. Only pass on links the CLI actually printed — never assemble one from an id yourself.
